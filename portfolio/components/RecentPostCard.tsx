...
const RecentPostCard: FC<Props> = ({ fullSlug, title, image, intro, tags }) => {
  return (
    <Link href={`/${fullSlug}`}>
      <a className="inline-block w-72 shrink-0 snap-center overflow-hidden rounded-lg bg-slate-50 shadow-lg transition-all md:w-96 md:hover:scale-[1.02] md:hover:shadow-xl">
